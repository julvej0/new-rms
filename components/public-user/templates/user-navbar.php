                        ...
                        <ul class="nav-links">
                            <?php if( isset($_SESSION['account_type']) ): ?>
                                <?php if ($_SESSION['account_type'] == "Admin"): ?>
                                    <li><a href="../../../admin/dashboard/dashboard.php" id='home-link' onclick="showLoadingScreen()">DASHBOARD</a></li>
                                    <li><a href="../../../admin/publications/publications.php" id='pb-link' onclick="showLoadingScreen()">PUBLICATIONS</a></li>
                                    <li><a href="../../../admin/ip-assets/ip-assets.php" id='ip-assets-link' onclick="showLoadingScreen()">IP ASSETS</a></li>
                                    <li><a href="../../../admin/authors/authors.php" id='author-link' onclick="showLoadingScreen()">AUTHORS</a></li>
