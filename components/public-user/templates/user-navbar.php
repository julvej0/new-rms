                            ...
                            <ul class="nav-links">
                                <?php if (isset($_SESSION['account_type'])): ?>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <li><a href="../../../views/public-user/ip-assets/ip-assets.php" id='ip-assets-link'
                                                onclick="showLoadingScreen()">IP ASSETS</a></li>
                                        <li><a href="../../../views/public-user/articles/articles.php" id='pb-link'
                                                onclick="showLoadingScreen()">PUBLICATIONS</a></li>
                                        <li><a href="../../../views/public-user/about/about.php" id='abt-link'
                                                onclick="showLoadingScreen()">ABOUT</a></li>
                                    <?php endif; ?>
                                <?php else: ?>
                                    <li><a href="../../../views/public-user/home/home.php" id='home-link'
                                            onclick="showLoadingScreen()">HOME</a></li>
                            ...
                            <div class="dropdown-container <?= $sessionActive ? 'show' : '' ?>">
                                <?php if ($sessionActive): ?>
                                    ...
                                    <div class="dropdown" id="dropdown">
                                        ...
                                        <?php endif; ?>
                                        <!-- href="../../../views/public-user/profile/change-password.php" -->
