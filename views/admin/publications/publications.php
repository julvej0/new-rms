            ...
            <div class="header">
                ...
                <div class='left'>
                    <div class="btn-container">
                        <button class="select-columns-btn" onclick="rotateButton()" id="button-icon"
                            title="Edit Table Column"><i class="fa-solid fa-caret-down"></i></button>
                    ...
                    <div class="filter">
                        ...
                        <ul class="filter-link">
                            ...
                            <li><a href="<?= filterPublication($search, 'Original Article', $fund, $year); ?>">Original
                                    Article</a></li>
                            <li><a href="<?= filterPublication($search, 'Review', $fund, $year); ?>">Review</a></li>
                            <li><a
                                    href="<?= filterPublication($search, 'Proceedings', $fund, $year); ?>">Proceedings</a>
                            </li>
                            <li><a
                                    href="<?= filterPublication($search, 'Communication', $fund, $year); ?>">Communication</a>
                            </li>
                            <li><a
                                    href="<?= filterPublication($search, 'International', $fund, $year); ?>">International</a>
                            </li>
                            <?php
                    ...
                    <div class="filter">
                        <button class="btn">
                            <?= $fund != "empty_fund" ? $fund : 'Fund' ?><i class='bx bx-chevron-down icon'></i>
                        </button>
                        <ul class="filter-link">
                            ...
                            <li><a href="<?= filterPublication($search, $type, 'Non-Funded', $year) ?>">Non-funded</a>
                            </li>
                        </ul>
                    </div>
                    <div class="filter">
...
if (isset($_GET['upload'])) {
    ...
    if ($uploadStatus == 'success') {
        ...
        const Toast = Swal.mixin({
            ...
            Toast.fire({
                icon: "error",
                title: "Failed to upload Publication, Author name not found!"
            })
