...
<body>
    <main>
        ...
        <section>
            <div class="container">
                <form name="form-pb" id="form-pb" action="../functionalities/button_functions/publication-insert.php"
                    ...
                    <div class="sub-container">
                        ...
                        <div class="form-col">
                            <div class="form-container">
                                ...
                                <div class="form-control">
                                    <label class="pb-label" for="pb-type">Type of Document <span
                                            style="color: red;">*</span></label>
                                ...
                                <div class="form-control">
                                    <label class="pb-label" for="pb-publisher">Publisher <span
                                            style="color: red;">*</span></label>
                                ...
                                <div class="form-control">
                                    <label class="pb-label" for="pb-research-area">Research Area <span
                                            style="color: red;">*</span></label>
                                    <input type="text" id="pb-research-area" name="research_area"
                                        placeholder="Research Area" required>
                                </div>
                            </div>
                            <div class="form-container">
                                <div class="form-control">
                                    <label class="pb-label" for="pb-college">College <span
                                            style="color: red;">*</span></label>
                                ...
                                <div class="form-control">
                                    <label class="pb-label" for="pb-campus">Campus <span
                                            style="color: red;">*</span></label>
                                ...
                                <div class="form-control">
                                    <div class="quartile-row">
                                        <div class="quarter">
                                            <label class="pb-label" for="pb-quarter">Quarter <span
                                                    style="color: red;">*</span></label>
                                        ...
                                        <div class="quarter-year">
                                            <label class="pb-label" for="pb-quarter-year">Year <span
                                                    style="color: red;">*</span></label>
                                ...
                                <div class="form-control">
                                    <label class="pb-label" for="pb-date-published">Date Published <span
                                            style="color: red;">*</span></label>
                                    <input type="date" max="<?= date('Y-m-d'); ?>" id="pb-date-published"
                                        name="date_published" placeholder="Date Published" required>
                                </div>
                            </div>
                            <div class="form-container">
                            ...
                            <div class="form-container">
                                <div class="form-control">
                                    <label class="pb-label" for="pb-abstract">Abstract <span
                                            style="color: red;">*</span></label>
                                    <textarea rows="13" id="pb-abstract" name="abstract" placeholder="Abstract..."
                                        required></textarea>
                                </div>
                            </div>
                            <div class="form-container">
