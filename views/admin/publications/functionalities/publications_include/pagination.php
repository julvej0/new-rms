...
<div class="table-footer">
    ...
    <div class="pagination">
        ...
        if ($total_pages > 1) {
            ...
            if ($fund != 'empty_fund') {
                unset($search_params['fund']);
                $params = array_merge($search_params, ['fund' => $fund]);
            }
            if ($year != 'empty_year') {
            ...
            ?>
            <li>
                <a href="<?php echo $link . (1); ?>" <?php echo ($page_number == 1 ? "style='pointer-events: none;'" : ""); ?>><i
                        class='bx bx-chevrons-left icon'></i></a>
            </li>
            <li>
