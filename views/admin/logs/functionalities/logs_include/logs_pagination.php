...
<?php
    //check if log searched, result is base on whether the log searched or not
    $count_text = $search != "empty_search" ? "Total Logs for \"". $search. "\" : " : "Total Logs :";
?>
