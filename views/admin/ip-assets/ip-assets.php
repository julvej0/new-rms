                ...
                <div class="left">
                    <div class="btn-container">
                        <button class="select-columns-btn" onclick="rotateButton()" id="button-icon"
                            title="Edit Table Column"><i class="fas fa-caret-down"></i></button>
                    ...
                    <form action='' method='get'>
                        <div class="form-group">
                            ...
                            <input type="hidden" name="class" value="<?= isset($_GET['class']) ? $_GET['class'] : 'empty_class' ?>">
                    ...
                    <div class="filter">
                        ...
                        <ul class="filter-link">
                            ...
                            <li><a href="<?= filterIPA($search, 'Industrial Design', $class, $year); ?>">Industrial
                                    Design</a></li>
                            <li><a href="<?= filterIPA($search, 'Trademark', $class, $year); ?>">Trademark</a></li>
                            <li><a href="<?= filterIPA($search, 'Copyright', $class, $year); ?>">Copyright</a></li>
                        </ul>
                    </div>
                    <div class="filter">
                        <button class="btn">
                            <?= $class != "empty_class" ? 'Class ' . $class : 'Class' ?><i
