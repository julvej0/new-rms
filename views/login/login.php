...
<!----------------------------------------------------------- login page ---------------------------------------------------------->
<div id="whole_page">
    <img src='./../../assets/images/background_img.jpg'
        style='opacity: 0.7; width: 100%; height: 100%; position:fixed;' />
    ...
    <img src='./../../assets/images/batStateUNeu-logo.png'
        style='width: 100px; height: 100px; position: fixed; border:solid 3px #cf102d; background-color: white; border-radius: 50%; z-index: 1; transform: translate(-50%, -300%); top: 50%; left: 50%;' />
    <!----------------------------------------------------------- login header ---------------------------------------------------------->
        ...
        <form onsubmit="return checkdata()" id='user_input' action="functionalities/login-account.php" method="POST">
            <div>
                ...
                <div id='password_container'>
                    <input id="login_password" class="passwordInput" name="password" placeholder="Password"
                        type="password" minlength='8' maxlength='16'>
                ...
                <label id='labelSignUp'>
                    Forgot Password?
                    <a id='a_SignUp' onclick="showModal()">&nbsp;Click Here!</a>
                </label>
                <br>
            </div>
        </form>
    ...
    <div class="modal-container">
        ...
        <form id="change-password-form" action='sample_db/change-password.php' method='POST'>
            ...
            <div class='password-container'>
                <input type="text" id="userEmailAddressInput" name="email" placeholder='example@g.batstate-u.edu.ph'
                    required>
            </div>
            ...
            <div class='password-container'>
                <input type="password" id="confirmPasswordInput" name="confirm-password" minlength='8' maxlength='16'
                    required>
                <i class="toggle-password fas fa-eye-slash"></i>
            </div>
