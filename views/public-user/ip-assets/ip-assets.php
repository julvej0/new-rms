                ...
                <div class="right">
                    <form>
                        <div class="form-control" method="GET" action="">
                            <input type='text' name='search-table' placeholder='Search Article or Author'
                                value="<?= isset($_GET['search-table']) ? $_GET['search-table'] : '' ?>">
                    ...
                    <div class="sort-btn">
                        ...
                        <ul class="sort-links">
                            <li><a
                                    href="<?= sortLink($search_query, 'title', $dateStart_query, $dateEnd_query, $campus_query) ?>">by
                                    Title</a></li>
                            <li><a
                                    href="<?= sortLink($search_query, 'date', $dateStart_query, $dateEnd_query, $campus_query) ?>">by
                                    Date</a></li>
                            <li><a
                                    href="<?= sortLink($search_query, 'campus', $dateStart_query, $dateEnd_query, $campus_query) ?>">by
                                    Campus</a></li>
                        </ul>
                    </div>
                    <div class="filter-btn">
                        ...
                        <div class="filter-options">
                            <form action="">
                                <input type="hidden" name="search-table"
                                    value="<?= $search_query != 'empty_search' ? $search_query : '' ?>">
                                <input type="hidden" name="sort"
                                    value="<?= $sort_query != 'empty_sort' ? $sort_query : '' ?>">
                                ...
                                <div class="checkbox-filter">
                                    ...
                                    <div class="checkbox-control">
                                        <input type="checkbox" id="alangilan" name="select-campus[]" class='campus-bsu'
                                            value="Alangilan (Main II)">
                                        <label for="alangilan">Alangilan (Main II)</label>
                                    </div>
                                    <div class="checkbox-control">
                                        <input type="checkbox" id="central" name="select-campus[]" class='campus-bsu'
                                            value="Central">
                                        <label for="central">Central</label>
                                    </div>
                                    <div class="checkbox-control">
                                        <input type="checkbox" id="lipa" name="select-campus[]" class='campus-bsu'
                                            value="Lipa">
                                        <label for="lipa">Lipa</label>
                                    </div>
                                    <div class="checkbox-control">
                                        <input type="checkbox" id="lobo" name="select-campus[]" class='campus-bsu'
                                            value="Lobo">
                                        <label for="lobo">Lobo</label>
                                    </div>
                                    <div class="checkbox-control">
                                        <input type="checkbox" id="mabini" name="select-campus[]" class='campus-bsu'
                                            value="Mabini">
                                        <label for="mabini">Mabini</label>
                                    </div>
                                    <div class="checkbox-control">
                                        <input type="checkbox" id="malvar" name="select-campus[]" class='campus-bsu'
                                            value="Malvar">
                                        <label for="malvar">Malvar</label>
                                    </div>
                                    <div class="checkbox-control">
                                        <input type="checkbox" id="nasugbu" name="select-campus[]" class='campus-bsu'
                                            value="Nasugbu">
                                        <label for="nasugbu">Nasugbu</label>
                                    </div>
                                    <div class="checkbox-control">
                                        <input type="checkbox" id="pb-main" name="select-campus[]" class='campus-bsu'
                                            value="Pablo Borbon (Main I)">
                                        <label for="pb-main">Pablo Borbon (Main I)</label>
                                    </div>
                                    <div class="checkbox-control">
                                        <input type="checkbox" id="rosario" name="select-campus[]" class='campus-bsu'
                                            value="Rosario">
                                        <label for="rosario">Rosario</label>
                                    </div>
                                    <div class="checkbox-control">
                                        <input type="checkbox" id="lemery" name="select-campus[]" class='campus-bsu'
                                            value="Lemery">
                                        <label for="lemery">Lemery</label>
                                    </div>
                                </div>
