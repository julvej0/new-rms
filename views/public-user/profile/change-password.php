        ...
        <div class="modal-content">
            ...
            <form id="change-password-form">
                ...
                <div class='password-container'>
                    <input type="password" class="oldPasswordInput" name="current-password" minlength='8' maxlength='16'
                        required>
                    <i class="toggle-password fas fa-eye-slash"></i>
                </div>
                <label for="new-password">New Password:</label>
                <div class='password-container'>
                    <input type="password" class="passwordInput" name="new-password" minlength='8' maxlength='16'
                        required>
                    <i class="toggle-password fas fa-eye-slash"></i>
                </div>
                <label for="confirm-password">Confirm Password:</label>
                <div class='password-container'>
                    <input type="password" id="confirmPasswordInput" name="confirm-password" minlength='8'
